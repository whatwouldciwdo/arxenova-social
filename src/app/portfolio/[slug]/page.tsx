...
const portfolios = {
    "otobi-auto-detailing": {
        ...
        img1: "/images/portfolio/otobi/otobi-arxenova-portfolio.webp",
    ...
    "berdikari-raya-services": {
        ...
        img1: "/images/portfolio/berdikariraya/berdikari-arxenova.webp",
    ...
    "putra-jayantara-ananta": {
        ...
        img1: "/images/portfolio/putrajayantara-ananta/putrajayantara-ananta-valve.webp",
    ...
    "pln-indonesia-power": {
        ...
        liveUrl: "https://www.plnindonesiapower.co.id/",
        ...
        img1: "/images/portfolio/plnindonesiapower/plnindonesiapower-arxenova.webp",
                    ...
                    <div className="portfolio-detail__header">
                        ...
                        <div className="portfolio-detail__meta-col">
                            ...
                            {('liveUrl' in data) && data.liveUrl && (
                                <a href={data.liveUrl as string} target="_blank" rel="noopener noreferrer" className="meta-link">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
